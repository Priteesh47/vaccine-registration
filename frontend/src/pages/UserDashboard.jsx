            ...
            <div>
              <div className="mb-8">
                ...
                <p className="mt-2 text-gray-600">
                  Browse and book your vaccination appointments
                </p>
              </div>
                ...
                {vaccines.map((vaccine) => (
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={
                          vaccine.image || "https://via.placeholder.com/400x300"
                        }
                        alt={vaccine.name}
                ...
                {centers.map((center) => (
                  ...
                  >
                    <div className="relative h-48">
                      <img
                        src={
                          center.image || "https://via.placeholder.com/400x300"
                        }
                        alt={center.name}
                        className="w-full h-full object-cover"
                      />
